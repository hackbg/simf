/** Previously, this function showed up as a missing `env.__assert_fail` import of the WASM module.
  * This was not trivial to polyfill on the JS side in all contexts.
  *
  * - What it is:
