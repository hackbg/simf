...
export const split: (a: any) => [number, number, number];
export const splitMulti: (a: any) => [number, number, number];
export const splitMultiSigned: (a: number, b: any) => [number, number, number, number];
export const splitSigned: (a: number, b: any) => [number, number, number, number];
