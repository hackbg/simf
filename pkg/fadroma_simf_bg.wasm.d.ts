...
export const pst_toSigned: (a: number, b: number) => [number, number, number];
export const pst_toTx: (a: number) => [number, number, number];
export const sendSigned: (a: number, b: any) => [number, number, number];
export const sendUnsigned: (a: any) => [number, number, number];
export const sendUnsignedTx: (a: any) => [number, number, number];
export const sign: (a: number, b: number) => [number, number, number];
